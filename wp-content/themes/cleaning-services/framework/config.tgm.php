...
class TGMRequiredPlugins {
	...
	public function __construct() {
		...
		add_action( 'tgmpa_register', array( $this, 'cleaning_services_register_required_plugins' ) );
	}
	...
	public function cleaning_services_register_required_plugins() {

		$plugins = array(
			array(
				'name'               => esc_html__( 'Elementor', 'cleaning-services' ), // The plugin name
			...
			array(
				'name'               => esc_html__( 'Envato Market', 'cleaning-services' ), // The plugin name
