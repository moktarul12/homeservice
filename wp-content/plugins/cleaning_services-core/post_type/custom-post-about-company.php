...
function cleaning_services_about_tabs_post_type() {
	...
	if ( isset( $cleaning_services_opt['cleaning_services-custom_post_type_off'] ) && $cleaning_services_opt['cleaning_services-custom_post_type_off'] != 1 ) {
		...
		$labels = array(
			'name'                  => _x( 'About Tabs', 'Post Type General Name', 'cleaning_services' ),
			'singular_name'         => _x( 'About Tabs', 'Post Type Singular Name', 'cleaning_services' ),
			'menu_name'             => __( 'About Tabs', 'cleaning_services' ),
			'name_admin_bar'        => __( 'About Tabs', 'cleaning_services' ),
			'archives'              => __( 'Item Archives', 'cleaning_services' ),
			'parent_item_colon'     => __( 'Parent Item:', 'cleaning_services' ),
			'all_items'             => __( 'All About Tabs', 'cleaning_services' ),
			'add_new_item'          => __( 'Add New About Tab', 'cleaning_services' ),
			'add_new'               => __( 'Add New About Tab', 'cleaning_services' ),
			'new_item'              => __( 'New About Tab Item', 'cleaning_services' ),
			'edit_item'             => __( 'Edit About Tab Item', 'cleaning_services' ),
			'update_item'           => __( 'Update About Tab Item', 'cleaning_services' ),
			'view_item'             => __( 'View About Tab Item', 'cleaning_services' ),
		...
		$args = array(
			...
			'show_in_menu'       => true,
			'query_var'          => true,
			'rewrite'            => array( 'slug' => 'cleaning_about_us' ),
		...
		register_post_type( 'cleaning_about_tabs', $args );
	}
}
add_action( 'init', 'cleaning_services_about_tabs_post_type', 0 );
